...
#python MNB_classifier.py reviews.tsv outputMNB.txt
...
print(my_report)
""" 
plot.plot_classification_report(testing_y, predict_y, ml_name='MNB',
                                  classes=labels,
                                  title='Classification report for MNB_classifier') """